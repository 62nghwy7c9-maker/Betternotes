...
def test_top_news_filters_old_items(config, fake_claude, monkeypatch):
    ...
    fake_claude.messages.reply = "#### Frisch (05.07.2026)\nZusammenfassung."
    md = top_news_markdown(fake_claude, config, date(2026, 7, 6))
...
def test_no_items_gives_notice_without_api_call(config, fake_claude, monkeypatch):
